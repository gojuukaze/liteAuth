...
import lite_auth_http.app.validator
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uid', models.CharField(help_text='用户的登录名，相当于ldap的 cn/uid/sn<br>「 uid只允许字母，数字，下划线（_），横杆（-） 」', max_length=50, unique=True, validators=[lite_auth_http.app.validator.UidValidator()], verbose_name='用户名/uid')),
                ...
                ('password_never_expire', models.BooleanField(default=False, verbose_name='密码用户过期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gid', models.CharField(max_length=30, unique=True, verbose_name='组名/gid')),
